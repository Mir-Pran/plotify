...
export default function Footer() {
  ...
  // Hide the global website footer on authentication pages and admin panel
  ...
  return (
    <footer className="backdrop-blur-md bg-slate-100/90 dark:bg-black/50 text-slate-600 dark:text-slate-400 pt-16 pb-10 transition-colors duration-200">
